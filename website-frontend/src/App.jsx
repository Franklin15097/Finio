    ...
    <div className="app">
      <header style={{ 
        ...
        <div className="container" style={{ 
          ...
          <nav style={{ display: 'flex', gap: '10px' }}>
            ...
            <a href="#register" className="btn btn-primary" style={{ padding: '0.5rem 1.5rem' }}>
              Регистрация
            </a>
          </nav>
        </div>
      ...
      <main className="container" style={{ paddingTop: '120px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '1rem' }}>
          <a href="#start" className="btn btn-primary" style={{ padding: '16px 32px', fontSize: '1.1rem' }}>
            Начать бесплатно
          </a>
          <a href="#learn" className="btn btn-outline" style={{ padding: '16px 32px', fontSize: '1.1rem' }}>
            Узнать больше
          </a>
        </div>
