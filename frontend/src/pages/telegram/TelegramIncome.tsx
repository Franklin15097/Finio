  ...
  return (
    <div className="p-4 space-y-3 pb-24">
      ...
      <button
        ...
        className="fixed right-4 bottom-32 w-14 h-14 bg-gradient-to-r from-green-500 to-emerald-600 rounded-full flex items-center justify-center shadow-2xl z-30 hover:scale-110 transition-transform"
      >
