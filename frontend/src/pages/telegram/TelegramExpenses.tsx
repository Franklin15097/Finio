...
import { Plus, TrendingDown, Search, Edit2, Trash2, X, Tag } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 pb-6">
      ...
      <div className="p-6 pb-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="w-10 h-10 bg-gradient-to-br from-red-500 to-pink-600 rounded-full flex items-center justify-center active:scale-95 transition-all shadow-lg"
            >
        ...
        {/* Total */}
        <div className="bg-gradient-to-br from-red-500 to-pink-600 rounded-3xl p-6 shadow-2xl">
          <div className="text-sm text-white/90 mb-1">Всего расходов</div>
        ...
        <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-3 border border-slate-700/50">
          <div className="relative mb-3">
            ...
            <input
              ...
              className="w-full pl-10 pr-3 py-2 bg-slate-700/50 border border-slate-600/50 rounded-xl text-sm text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500"
            />
          </div>
          ...
          <select
            ...
            className="w-full px-3 py-2 bg-slate-700/50 border border-slate-600/50 rounded-xl text-sm text-white focus:outline-none focus:ring-2 focus:ring-red-500"
          >
        ...
        <form onSubmit={handleTransactionSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:ring-2 focus:ring-red-500 focus:border-transparent"
              placeholder="0.00"
            />
          </div>
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white focus:ring-2 focus:ring-red-500 focus:border-transparent"
            >
          ...
          <button
            type="submit"
            className="w-full py-3 bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-xl font-semibold active:scale-95 transition-all shadow-lg"
          >
