...
Используйте скрипт полной автоматической установки:
...
|--------|-----------|---------------|
| **full_server_setup.sh** | Первоначальная установка | На сервере |
| **deploy.sh** | Автоматический деплой | На локальной машине |
| **update_server.sh** | Быстрое обновление | На сервере |
